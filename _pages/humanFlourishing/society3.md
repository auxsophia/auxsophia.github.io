...
Here is where I would like the input of economists and others with a fresh perspective: running a circular, [degrowth](https://en.wikipedia.org/wiki/Degrowth) economy. To make this generalized, communities should interact with the society their in trading for needed goods and service in the established currency. The eventual goal of every community should be to disconnect as much as possible from the establishment currency and gradually grow local wealth.
